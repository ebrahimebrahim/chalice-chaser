...
struct GraphicsData{
    ...
    std::experimental::optional<glm::vec3> object_color;
};
...
class GraphicsObject {
    ...
    std::experimental::optional<glm::vec3> object_color; /**< Optional color, which if present will be set as a uniform "object_color" in the shader */
