...
If your libglfw3 version is too old, then you can install a new one by [cloning the glfw repo](https://github.com/glfw/glfw)
and doing the following to install it:
```
mkdir build
cd build
cmake ..
...
Finally, build Chalice Chaser on linux:
```
mkdir build
cd build
cmake ..
